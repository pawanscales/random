...
const VideoCall: React.FC = () => {
  ...
  const [meetingName, setMeetingName] = useState('Partai Banteng Weekly Meeting');
  ...
  return (
    <div className={styles.container}>
      ...
      <Modal isOpen={isExitModalOpen} onRequestClose={handleModalClose} className={styles.modal}>
        <h2>Exit the meeting?</h2>
        <button onClick={handleExitConfirm}>Yes, Exit</button>
        <button onClick={handleModalClose}>Cancel</button>
      </Modal>
      <Modal isOpen={isLeaveModalOpen} onRequestClose={handleModalClose} className={styles.modal}>
        <h2>Leave the meeting?</h2>
        <button onClick={handleLeaveConfirm}>Yes, Leave</button>
        <button onClick={handleModalClose}>Cancel</button>
      </Modal>
    </div>
  );
